...
import { VStack, Grid, Divider, Button } from '@chakra-ui/react';
          ...
          {!isLoading &&
            data['SMG']?.map((a, i) => (
              <GalleryCard
                ...
                dateCreation={
                  a.attributes.lifecycle?.creation?.date &&
                  a.attributes.lifecycle.creation[0].date[0].value
                }
                restPayload={[
                  a.attributes.categories && {
                    type: 'Category',
                    data: a.attributes.categories[0].name,
                  },
                ]}
              />
            ))}
